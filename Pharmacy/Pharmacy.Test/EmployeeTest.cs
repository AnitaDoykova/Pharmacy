...
namespace Pharmacy.Test
{
    public class EmployeeTests
    {
        ...
        {
            {new Employee() {Id = 1, Name = "TestName", Salary = 500}},
            {new() {Id = 2, Name = "TestName2", Salary = 550}}
        };
        ...
        [Fact]
        public void Employee_GetById_SalaryCheck()
        {
            //setup
            var employeeId = 2;
            var expectedSalary = 550;
        ...
        public void Employee_Update_EmployeeName()
        {
            ...
            //Act
            var employeeUpdateRequests = _mapper.Map<EmployeeUpdateRequests>(employee);
            var result = _employeeController.Update(employeeUpdateRequests);
        ...
        public void Employee_CreateEmployee()
        {
            ...
            //Act
            var result = _employeeController.CreateEmployee(_mapper.Map<EmployeeRequests>(employee));
