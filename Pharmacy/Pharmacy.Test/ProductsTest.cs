...
namespace Pharmacy.Test
{
    public class ProductsTests
    {
        ...
        private IList<Products> Productss = new List<Products>()
        {
            ...
            {new() {Id = 2, Name = "TestName2", Price = 4.5}}
        };
        ...
        public void Products_Update_ProductsName()
        {
            ...
            //Act
            var productsUpdateRequests = _mapper.Map<ProductsUpdateRequests>(products);
            var result = _productsController.Update(productsUpdateRequests);
        ...
        public void Products_CreateProducts()
        {
            ...
            //Act
            var result = _productsController.CreateProducts(_mapper.Map<ProductsRequests>(products));
