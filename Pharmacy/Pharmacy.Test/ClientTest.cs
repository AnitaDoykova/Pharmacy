...
namespace Pharmacy.Test
{
    public class ClientTests
    {
        ...
        {
            {new Client() {Id = 1, Name = "TestName", MoneySpend = 2.8}},
            {new() {Id = 2, Name = "TestName2", MoneySpend = 3.8}}
        };
        ...
        public void Client_Update_ClientName()
        {
            ...
            //Act
            var clientUpdateRequests = _mapper.Map<ClientUpdateRequests>(client);
            var result = _clientController.Update(clientUpdateRequests);
        ...
        public void Client_CreateClient()
        {
            ...
            //Act
            var result = _clientController.CreateClient(_mapper.Map<ClientRequests>(client));
